...
class Trainer(object):
    ...
    def train_epoch(self):
        ...
        # with torch.snooper.snoop():
        for batch_id, inputs in enumerate(tqdm(self.train_iter), 1):
            self.model.train()
            ...
            if batch_id % self.log_steps == 0:
                ...
                print('Current learning rate:', self.optimizer._optimizer.param_groups[0]["lr"])
