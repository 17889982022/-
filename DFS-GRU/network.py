...
from source.cesu.fops import measure_model
...
def model_config():
    ...
    data_arg.add_argument("--save_dir", type=str, default="./models/models_PMI_0-4/")
...
#     net_arg.add_argument("--teacher_forcing_ratio", type=float, default=0.5)
    ...
    train_arg.add_argument("--n_warmup_steps", type=float, default=10000)
    train_arg.add_argument("--num_epochs", type=int, default=30)
    train_arg.add_argument("--pretrain_epoch", type=int, default=0)
    train_arg.add_argument("--lr_decay", type=float, default=0.25)
...
#     train_arg.add_argument("--use_chain", type=str2bool, default=False)
    ...
    gen_arg.add_argument("--gen_file", type=str, default="./output/Exper-PMI/DFS_GRU_seen_PMI_0-4.result")
    gen_arg.add_argument("--gold_score_file", type=str, default="./gold.scores")

    # MISC
    misc_arg = parser.add_argument_group("Misc")
    misc_arg.add_argument("--gpu", type=int, default=0)
    misc_arg.add_argument("--log_steps", type=int, default=250)
    misc_arg.add_argument("--valid_steps", type=int, default=2500)
    misc_arg.add_argument("--batch_size", type=int, default=1)
    # misc_arg.add_argument("--ckpt", type=str, default=None)
    misc_arg.add_argument("--ckpt", type=str, default='./models/models_PMI_0-4/state_epoch_6.model')
...
def main():
    ...
    # Testing
        ...
        Schedile_optimizer = ScheduledOptim(optimizer, config.hidden_size, config.n_warmup_steps)
        ...
        trainer = Trainer(model=model, optimizer=Schedile_optimizer, train_iter=train_iter,
                          ...
                          lr_scheduler=None, save_summary=True)
